	...
	for (int i = 0; i < numberOfBookings; i++) {
		if (login == ticket[i].login) {
			if (ID == ticket[i].concertID) {
				...
				// èç òèêåòîâ óäàëèòü çàïèñü, åñëè êîëè÷åñòâî áèëåòîâ ñîâïàäàåò, åñëè íå ñîâïàäàåò, îòðåäà÷èòü. íàñòðîèòü êàê ðàçíûå ôóíêöèè
				if (ticket[i].amount == amount) {
					//delete record. ëîãèí è àéäèøíèê êîíöåðòà íàéäåíû âî âíåøíåì öèêëå
